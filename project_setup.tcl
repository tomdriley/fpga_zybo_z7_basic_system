...
#
# Generated by Vivado on Sun Jun 16 20:18:28 -0400 2024
...
if { [get_property IS_LOCKED [ get_files -norecurse basic_system_design.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/basic_system.gen/sources_1/bd/basic_system_design/hdl/basic_system_design_wrapper.v" ]
} else {
