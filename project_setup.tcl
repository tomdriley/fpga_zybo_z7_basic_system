...
#
# Generated by Vivado on Sun Jun 16 20:46:51 -0400 2024
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-661,-238",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 2 -x 440 -y 20 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 2 -x 440 -y 40 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -x 210 -y 100 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 210 -y 310 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 2 30 200 390
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 20 0 400
preplace netloc processing_system7_0_DDR 1 1 1 410 20n
preplace netloc processing_system7_0_FIXED_IO 1 1 1 420 40n
levelinfo -pg 1 0 210 440
pagesize -pg 1 -db -bbox -sgen 0 -10 550 410
"
}
